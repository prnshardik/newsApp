    ...
    <div class="page-content fade-in-up">
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-head">
                        <h1 class="ibox-title">Reporter</h1>
                        <h1 class="pull-right">
                            @canany(['reporter-create'])
                                <a class="btn btn-primary pull-right" style="margin-top: 8px;margin-bottom: 5px" href="{{ route('admin.reporter.create') }}">Add New</a>
                            @endcanany
                        </h1>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function change_status(object){
            ...
            if (confirm('Are you sure?')) {
                $.ajax({
                    "url": "{!! route('admin.reporter.change.status') !!}",
                    "dataType": "json",
                    "type": "POST",
                    "data":{
                        id: id,
