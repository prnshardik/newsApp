    ...
    <div class="page-content fade-in-up">
        <div class="row">
            <div class="col-md-12">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">District Create</div>
                    </div>
                    <div class="ibox-body">
                        <form action="{{ route('admin.district.insert') }}" name="form" id="form" method="post">
                            @csrf
                            @method('POST')
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('admin.district') }}" class="btn btn-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
